    ...
    public class FoodController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            try
            {
                ...
                var json = client.DownloadString("http://mykcserver.apphb.com/api/MonAn/LayMonAn/" + id.ToString());
        ...
        public ActionResult POST(HttpPostedFileBase file)
        {
            ...
            //Upload hinh
            Account account = new Account("di1dlvxy4", "828786263733179", "63tSyooQ5klKITiVTc-TuO4CxVQ");
